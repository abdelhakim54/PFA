...
from Fine_Tuning_ResNet50_function import Binary_ResNet50_FineTunning
...
#**************************************************************************
print("\n\t[INFO] ResNet50_FineTunning...")
MyModel=Binary_ResNet50_FineTunning(input_shape,optimizer,ClassificationType,lossV,NbClass)
MyModel.summary()
#**************************************************************************
...
mc = ModelCheckpoint('Model/ResNet50_FT.h5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
...
SaveHistory(history,'ResNet50_FT_')
PlotFigures(history,MyModel,'ResNet50_FT_')
validation_steps = (test_set.classes.shape[0]//batch_size+1)#+1 Obligatoire pour la matrice de confusion
ConfutionMatrix_ClassificationReport(MyModel,'ResNet50_FT_',test_set,validation_steps)
